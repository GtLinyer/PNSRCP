 ...
 * @Date: 2022/07/19 16:59 星期二
 * @Description: 基础数据库 循环系统 超声
 */
@Getter
@Setter
@TableName("pc_bd_ns_ultrasonography")
public class BDNsUltrasonography {
    ...
    private String csFlUrl;
    private String csLvahlUrl;
    private String csTvlUrl;
    private String csLvcpPhlUrl;
    private String csOllUrl;
    private String csClUrl;
    private String ssMpUrl;
    private String ssLvahlUrl;
    private String ssLvcpPhlUrl;
    private String ssItllUrl;
    private String ultrasoundExplanation;
}
